 ...
 *
 * 업무보드 왼쪽 아래에 있었는데, 직원들이 어차피 구글챗을 따로 띄워놓고 일하기 때문에
 * 같은 대화를 그 좁은 칸에 한 번 더 비추는 것이 자리만 먹었습니다. 그 자리는 이제
 * [학생 특이사항]입니다(`StudentDayNotes`).
 *
 * **지우지 않고 남겨둡니다.** 앱에서 구글챗에 답을 보내는 길은 여기 하나뿐이라(멘션을
 * 사람 번호로 바꿔 보내는 것 포함), 지우면 그 기능이 함께 사라집니다. 다시 어딘가에
 * 걸 때는 이 부품을 그대로 쓰면 됩니다.
 *
 * ── 원래 왜 그 자리에 있었나 ─────────────────────────────────────────
 *

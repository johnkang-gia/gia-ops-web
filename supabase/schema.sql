...
-- ===== 픽업 인박스 =====
-- 토들·전화·교사·직접입력 어디로 들어온 픽업 연락이든 한 곳에 모아 AI가 판단합니다.
-- 자세한 설계 메모는 supabase/migrations/20260824090000_pickup_inbox.sql에 있습니다.
...
-- ============================================================================
--  108. 학부모 문의사항 (20260824140000_parent_inquiries.sql)
-- ============================================================================

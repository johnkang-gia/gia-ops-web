...
const GUIDE_SECTIONS = [
  {
    ...
    lines: [
      ...
      "지금 각 반이 무슨 수업 중인지(반 이름 옆에 담임 이름도 함께), 오늘 결석·지각·픽업 학생이 누구인지, 오늘 마감이거나 새로 등록된 업무가 무엇인지를 한 화면에 보여주고 30초마다 자동으로 갱신됩니다.",
      "2026학년도 3학기 기준으로 초등부 8개 반 시간표(7교시 × 5일)가 이미 채워져 있습니다. \"지금 수업\"이 비어 보이면 아래 표에서 그 요일·교시 칸이 실제로 비어 있는 것이니 확인해주세요.",

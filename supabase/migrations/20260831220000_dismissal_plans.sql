-- 하원수단 (학생 × 요일)
--
-- 담당자: "월: 셔틀 / 화: 1:55 메타프랩버스 / 수: 4:30 블루웨일버스 / 목: 1:55 메타프랩버스 /
--          금: 3:35 블루웨일버스 — 백서아의 일정이야. 이런 경우 어떻게 등록하고 관리하지?"
--          "하원수단 칸을 만들고 그거 아이를 기준으로 저장되게 해줘. 나중에 담임선생님
--           화면에서도 아이를 기준으로 떠서 선생님이 아이를 데리고 올 수 있도록."
--

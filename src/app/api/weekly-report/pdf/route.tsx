...
export async function GET(request: Request) {
  try {
    ...
    console.error("[주간 관찰기록 PDF] 만들지 못했습니다:", e);
    return new Response(`주간 관찰기록 PDF를 만들지 못했습니다.\n\n${msg}`, {
      status: 500,
...
async function handle(request: Request) {
  ...
  return new Response(new Uint8Array(buffer), {
    headers: {
      ...
      "content-disposition": pdfDisposition(`${(student as WrStudent).name}_${filenameSuffix}`),
    },
  });
}

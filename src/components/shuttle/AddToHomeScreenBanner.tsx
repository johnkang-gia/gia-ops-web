...
const SHOWN_KEY = "gia-a2hs-banner-shown";
...
// 공유 버튼, 안드로이드는 브라우저 메뉴로 안내 문구를 다르게 보여줍니다.
//
// 요청: "추가자동안내는 초기 한번만 해주고" - 처음 열었을 때 한 번만 보여주고, 그 뒤로는(닫든
// 안 닫든) 이 기기에서 다시 뜨지 않습니다.
export default function AddToHomeScreenBanner() {
  ...
  useEffect(() => {
    ...
    // 화면에 보여준 시점에 바로 "봤음" 표시를 해서, 닫기 버튼을 안 눌러도 다음 방문부터는
    // 다시 뜨지 않게 합니다.

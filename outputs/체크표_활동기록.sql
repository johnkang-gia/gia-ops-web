-- ═══════════════════════════════════════════════════════════════════════════
-- 하원 체크표 활동 기록 — Supabase SQL Editor 붙여넣기용
--
--   supabase/migrations/20260901120000_checklist_activity_log.sql
--
-- 이 표가 없으면 체크·이동은 평소대로 되지만 "누가 언제 무엇을"이 쌓이지 않습니다.
...
values ('20260901120000', 'checklist_activity_log')
on conflict (version) do nothing;

commit;

-- 확인 — true 가 나오면 성공입니다.
select to_regclass('public.shuttle_checklist_log') is not null as 활동기록_표_있음;

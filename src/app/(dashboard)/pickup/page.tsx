  ...
  if (myClasses.length === 0) {
    return (
      <div className="mx-auto max-w-lg py-16 text-center">
        <p className="text-lg font-semibold text-slate-700">담임으로 배정된 반이 없습니다.</p>
  ...
  return (
    <div className="mx-auto max-w-3xl p-4 sm:p-6">
      <div className="mb-1 flex items-center justify-between gap-2">
        <h1 className="text-lg font-bold">🚗 내 반 픽업 체크</h1>
        <GuideButton title="픽업 체크 사용 가이드" sections={GUIDE_SECTIONS} />
      </div>

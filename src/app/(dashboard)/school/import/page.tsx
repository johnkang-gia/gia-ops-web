...
const GUIDE_SECTIONS = [
  ...
  {
    title: "📋 신청서(학기/행사) 가져오기",
    lines: [
      "구글폼으로 받는 신학기 등록 신청, 행사 참가 신청의 응답 구글시트를 붙여넣으면 열 제목을 분석해 이름/연락처/학년 등 표준 항목으로 정리합니다.",
      "매칭 규칙을 템플릿으로 저장해두면, 다음에 같은 형식(같은 구글폼)의 시트를 붙여넣을 때 자동으로 알아봅니다.",
    ],
  },
  {
    title: "⚠️ 주의",

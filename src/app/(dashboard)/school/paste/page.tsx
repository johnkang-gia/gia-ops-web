...
const GUIDE_SECTIONS = [
  {
    title: "📋 어떻게 쓰나요?",
    lines: [
      "구글시트에서 넣고 싶은 줄을 «머리줄(이름·학년·반 …)까지 함께» 끌어서 복사한 뒤, 이 화면에 붙여넣습니다.",
      "머리줄의 글자를 보고 어느 칸인지 앱이 알아서 정합니다. 시트의 칸 순서가 달라도 됩니다 - 순서를 코드에 박아두면 어느 날 조용히 학년 칸에 반 이름이 들어갑니다.",
      "머리줄을 못 찾으면 짐작하지 않고, 어느 칸이 무엇인지 직접 고르게 합니다.",
  ...
  return (
    <div className="mx-auto w-full max-w-4xl p-4 sm:p-6">
      ...
      <p className="mb-3 text-xs leading-relaxed text-slate-500">
        구글시트에서 <b>머리줄까지 함께</b> 복사해 붙여넣으면 칸을 알아서 읽습니다. 넣기 전에 <b>무엇이 새로 생기고

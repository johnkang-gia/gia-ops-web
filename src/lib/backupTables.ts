...
export const BACKUP_SKIP: Record<string, string> = {
  payment_import_progress: "뷰입니다. 묶음과 줄에서 그때그때 세는 값이라 담아도 다시 쓸 것이 없습니다.",
  ...
  usage_events:
    "이용 기록(누가 어느 화면을 봤나). 학교 운영 자료가 아니라 화면 사용량을 세는 값이고, " +
    "사라져도 다시 쌓입니다. 사람에 대한 기록이라 내려받는 파일에 함께 담으면 그 파일의 성격이 바뀝니다.",

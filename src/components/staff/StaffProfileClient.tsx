...
export default function StaffProfileClient({
  ...
  return (
    <div>
      ...
      <div id="basic" className="mb-5 g-panel-solid p-4 shadow-sm scroll-mt-16">
      ...
      <div id="history" className="mb-5 g-panel-solid p-4 shadow-sm scroll-mt-16">
        <div className="mb-2 flex items-center justify-between">
      ...
      <div id="tasks" className="g-panel-solid p-4 shadow-sm scroll-mt-16">

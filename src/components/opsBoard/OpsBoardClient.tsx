...
// 엄청 띄엄띄엄 갱신해도 괜찮아."
//
// 완전히 멈추지 않고 30분으로 둔 이유: 아예 멈추면 아침에 스스로 깨어날 방법이 없습니다.
// 이 화면은 벽에 걸린 모니터라 아무도 탭을 다시 누르지 않아서, 타이머가 끊기면 누가 새로고침할
// 때까지 어제 화면이 그대로 남습니다. 30분에 한 번은 사실상 없는 것과 같은 부담(밤새 22번)이면서,
// 시계가 07시를 넘는 순간 스스로 빠른 주기로 돌아옵니다. useSmartPoll이 "근무 시작 시각을
// 넘겨서 자지 않도록" 잡아주므로 07:00 정각에 깨어납니다.

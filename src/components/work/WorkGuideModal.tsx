...
const SECTIONS: { title: string; lines: string[] }[] = [
  {
    title: "🖥️ 화면 구성 - 세 칸",
    lines: [
      "왼쪽 📥 인박스에서 들어오는 것을 받고, 가운데 🔀 업무 흐름판에서 처리하고, 오른쪽 💬 소통에서 이야기합니다. 이 화면만 띄워두고 하루 업무를 볼 수 있게 만든 배치입니다.",
      "칸 사이 회색 경계선을 마우스로 끌면 폭이 바뀝니다. 맨 위 머리글의 ✕를 누르면 그 칸이 세로 막대로 접히고, 흐름판이 화면을 거의 다 씁니다(업무를 몰아서 정리할 때 편합니다).",
      "바꾼 폭과 접어둔 상태는 이 브라우저에 기억되어 다음에 들어와도 그대로입니다.",
      "화면이 좁은 기기(휴대폰·태블릿)에서는 세 칸이 탭으로 바뀌어 한 번에 하나씩 보입니다.",
    ],
  },
  {
    title: "📥 인박스 - 들어오는 것",
